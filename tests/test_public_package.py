...
EXPECTED_PUBLIC_SUBMODULES = frozenset(
    ...
    'benchmarks',
    'cache',
    'canary_orchestration',
    'databricks_engine_probe_job',
    'databricks_job',
    'databricks_resource_ledger',
    'databricks_runs',
...
EXPECTED_CONSOLE_SCRIPTS = {
    ...
    'cachet-databricks-resource-ledger': 'cachet.databricks_resource_ledger:main',
    ...
    'cachet-method-conformance': 'cachet.method_conformance:main',
    'cachet-method-scaffold': 'cachet.method_scaffold:main',
    ...
    'document-kv-databricks-resource-ledger': 'document_kv_cache.databricks_resource_ledger:main',
    ...
    'document-kv-method-conformance': 'document_kv_cache.method_conformance:main',
    'document-kv-method-scaffold': 'document_kv_cache.method_scaffold:main',
