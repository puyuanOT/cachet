...
- `test_representative_hotpotqa.py` verifies deterministic tokenizer-only HotpotQA selection, exact 8k/16k/32k prompt sizing, pinned tokenizer loading, canonical output, and prompt-free provenance.
