...
- Release-evidence validation over the current target benchmark, storage, and
  ...
  the split vLLM/SGLang runtime probe environments. Strict bundles created
  after the dependency-freshness evidence PR also require a dependency
  freshness sidecar.
