...
- Release-evidence validation over the current target benchmark, storage, and
  ...
  strict-bundle snapshot was built after PR #505 with the current wheel and
  validates with 27 artifacts after replacing its benchmark/status sidecars with
  ...
  PR #442/#503/#504 evidence, and carrying `legacy_migration_evidence` for the
  removed restaurant facade. Traceability-only PR evidence added after that
  snapshot must be included in the next publication bundle refresh. The bundled
