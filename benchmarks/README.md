...
| [`sglang/`](sglang/) | SGLang benchmark status and live smoke folders | Generated-handoff Databricks smokes reached a positive 175-token external cache hit covering the generated Qwen-chat token-stable prefix through the chat-completions path with no-thinking controls; latest blocker is the failed Qwen3/SGLang live quality gate; live latency and quality benchmark pending |
...
[`sglang/`](sglang/), including the latest no-thinking chat-completions
cache-hit quality failure at
