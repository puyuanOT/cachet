...
| Folder | Purpose |
| --- | --- |
| [`representative-bf16-qwen3-4b-canaries/`](representative-bf16-qwen3-4b-canaries/) | Vanilla-v2 BF16 vLLM canaries, SGLang native-handoff smoke, and a six-job direct-versus-legacy cold-load ablation; non-publication-qualified |
