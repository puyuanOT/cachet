...
This page records QA run provenance for committed benchmark evidence. It is
intentionally secondary to the [benchmark root](../).
...
| SGLang prepared live V1 | [`../appendix/existing-results/sglang-qwen3-4b-g6-l4-vanilla-kv-prepared/`](../appendix/existing-results/sglang-qwen3-4b-g6-l4-vanilla-kv-prepared/) | `48413356233422` | `aws-g6-l4` / `g6.8xlarge` | 16 measurements; 8/8 Cachet-backed cache-hit validations; no latency improvement observed |
| SGLang synthetic NIAH | [`../appendix/existing-results/sglang-qwen3-4b-g6-l4-vanilla-kv-synthetic-niah/`](../appendix/existing-results/sglang-qwen3-4b-g6-l4-vanilla-kv-synthetic-niah/) | `238535418152934` | `aws-g6-l4` / `g6.8xlarge` | Two Cachet-backed cache repeats with 175 cached tokens; no latency improvement observed |
