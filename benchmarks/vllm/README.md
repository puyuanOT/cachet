...
vLLM latency and quality benchmark results. The canonical sanitized JSON
artifacts remain under `../databricks/` so release validation can audit the same
records cited here.
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| Strict AWS g6/L4, `g6.8xlarge` | `872615985402004` | [`../databricks/2026-06-23-g6-l4-v1/`](../databricks/2026-06-23-g6-l4-v1/) | 24 | 5.27x-6.97x | 1.74x-2.25x | 0.0 |
| Compatibility AWS g5/A10G, `g5.8xlarge` | `566743786103032` | [`../databricks/2026-06-23-g5-a10g-v1-compatibility/`](../databricks/2026-06-23-g5-a10g-v1-compatibility/) | 24 | 4.66x-6.04x | 2.04x-2.67x | 0.0 |
